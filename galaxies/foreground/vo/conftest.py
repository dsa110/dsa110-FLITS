...
def sample_targets():
    return [
        Target(name="FRB_Test_A", ra=150.1149, dec=2.2058, redshift=0.225),
        Target(name="FRB_Test_B", ra=210.8023, dec=54.3482, redshift=0.321),
        Target(name="FRB_Test_C", ra=45.6789, dec=-12.3456, redshift=None),
    ]
